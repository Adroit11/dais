 ...
 */
$config['site_title']                 = "NUMUN Support";       // Site Title, example.com
$config['admin_email']                = "support@numun.org"; // Admin Email, admin@example.com
$config['default_group']              = 'advisers';           // Default group, use name
...
$config['forgot_password_expiration'] = 86400000;            // 24 hours / The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
