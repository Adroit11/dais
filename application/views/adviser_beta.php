    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="container-fluid">
		...
		<noscript>
				...
				NUMUN requires JavaScript to be enabled in your browser. Please click <strong>Enable JavaScript</strong> for instructions.
				</div>
		</noscript>
		...
		<div class="row">
			...
			<div class="col-sm-10">
			<p class="lead">View your delegate count, country preferences, and additional advisers below.</p>
			</div>
			<div class="col-sm-5">
		...
		<div class="col-sm-7">
			...
			<button class="btn btn-warning" data-toggle="modal" data-target="#editPreferences"><i class="fa fa-pencil"></i> &nbsp;Add/Remove Delegates</button>
		</div>
		<!--</div>
		<div class="row">-->
		<div class="col-sm-7">
...
<div class="modal fade" id="editPreferences" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title">Editing Delegate Quantity & Preferences</h4>
      </div>
      <div class="modal-body">
      <p>To change the quantity of delegates you wish to bring to NUMUN XII, please email Michael McCarthy at support@numun.org and CC Priyanka Melgiri at registration@numun.org. <br />Clicking on the Create Email button below will start a message in your email client.</p>
      <p>
      <a class="btn btn-info" href="mailto:support@numun.org?cc=registration@numun.org">Create Email</a>
      </p>
		</div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
