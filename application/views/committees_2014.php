<?php 
	$conferenceid = 2;
	$committees_list = $this->committees_page->get_committees_list("xi");
	$committee_divs = $this->committees_page->get_committee_divs("xi");
...
<div class="modal fade" id="loc-mtc-2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title">McCormick Tribune Center 2nd Floor</h4>
      </div>
      <div class="modal-body">
        <p class="lead">Directions to McCormick Tribune Center AKA "McTrib"</p>
		...
		<p>
			<ol>
				...
				<li>Turn left at the next main path toward Kresge Hall and McCormick Tribune Center.</li>
				<li>McCormick Tribune Center will be on your left. Enter at the south end of the building and take the elevator to 2.</li>
			</ol>	
		...
		<p><strong>From Norris</strong></p>
			<ol>
				...
				<li>At the stairs, turn left and head south towards Kresge Hall and McCormick Tribune Center.</li>
				<li>McCormick Tribune Center will be on your left. Enter at the south end of the building and take the elevator to 2.</li>
			</ol>	
		</p>
      </div>
...
<div class="modal fade" id="loc-mtc-3">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title">McCormick Tribune Center 3rd Floor</h4>
      </div>
      <div class="modal-body">
        <p class="lead">Directions to McCormick Tribune Center AKA "McTrib"</p>
		<p><strong>From Pick-Staiger</strong></p>
		<p>
			<ol>
				...
				<li>Cross Campus Drive and continue straight ahead on the path.</li>
				<li>Turn left at the next main path toward Kresge Hall and McCormick Tribune Center.</li>
				<li>McCormick Tribune Center will be on your left. Enter at the south end of the building and take the elevator to 3.</li>
			</ol>	
